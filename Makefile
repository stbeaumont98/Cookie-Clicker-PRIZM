...
MKG3AFLAGS := -n basic:'Cookie Clicker' -i uns:../unselected.bmp -i sel:../selected.bmp
...
CFLAGS	= -O3 -Wall $(MACHDEP) $(INCLUDE) -ffunction-sections -fdata-sections -ffast-math -std=c11
